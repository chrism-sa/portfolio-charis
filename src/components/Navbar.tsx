  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-[999] transition-all duration-300 ${
        isScrolled
          ? "bg-[#050505]/90 backdrop-blur-md border-b border-white/10 py-4 shadow-lg"
          : "bg-transparent py-6"
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        >
          Charis
          <span className="text-accent-cyan group-hover:text-accent-purple transition-colors">
            .dev
          </span>
        </a>
        {/* Menu Desktop */}
        ...
        <button
          ...
          className="md:hidden relative z-[999] p-2 text-gray-300 hover:text-white focus:outline-none"
